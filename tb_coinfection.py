...
# OPTIONAL
# Define several optional arguments with their default values and corresponding descriptions
...
# Define color and formatting codes for printing text
...
def main():
    ...
    # Execute autosnippy and freebayes
